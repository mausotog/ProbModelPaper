...
@  for (CompilerInput input : inputs) {
	...
	\caption{Top: A snippet of the source code of the Closure 18 bug as fixed using the
      ...
      suite.\label{closure18prob}\todo{Mau, please have the lstings start the
        numbering at the line number of the actual source code in question
        (rather than at 1)RESPONSE: I did but I don't know how to make it repeat the line that was replaced... Line replaced is 1285. Also these long numbers interfere with the margin}}
\end{figure}


Figure~\ref{stateOfTheArtComparison} shows results, including, for each patch,
the number of held-out tests the patched program fails. Of the eleven\todo{revisit}
