...
\begin{figure}[!h]
  ...
  \caption{Correctly predicted percentage according to 10 fold cross
    validation. The probabilistic model is able to predict the correct statement kind to replace a faulty one in 87\% of the times, over 4 times better than the equally distributed model. \todo{expand this caption to draw conclusions, and stop saying ``applying'' with
