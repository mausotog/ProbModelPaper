...
\todo{MAU'S COMMENT: I performed the changes proposed, but I still think the Background/Categorization sections would work better. Now I feel we have a G\&V section that has two very clear background subsections and then a completely different categorization section. What are we gaining from merging those two?}
...
create candidate patches. \todo{MAU'S COMMENT: I removed the whole sentence because it made it seem like all stmt-edit mut HAVE to be randomized, which is not true.}
