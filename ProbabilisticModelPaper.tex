...
dataset, matched as described in Section~\ref{sec:mining}\footnote{Since the instance count that makes up the models is of notable size we have made it available through a link to our paper, which will be made available after the blind review process}, and then apply Laplace smoothing~\cite{Russell10} with $\alpha$ = 1 to account for 0 occurrences.
