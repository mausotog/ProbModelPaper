...
maintainability. There have been efforts to automate this complex task by 
...
edits that can be applied to the different sections of the source code. Since 
...
very difficult to solve, specially since every bug is different and every 
...
suite~\cite{Jones05,Jones02,Chen02,legoues12,Qi13}. This is not the 
...
%For what I understand from the paper AE uses the same random mutation operator 
...
In order to tackle this problem we have developed a probabilistic model mined 
...
empirical data that describes how human programmers fix their code; and we have 
evaluated this 
