...
guides the search process. We generate a single held out suite\todo{see the
  github issue I assigned to you} for each buggy program version that any technique
...
\subsubsection{Mutation operator rules}
...
\todo{Update the document with all the rules, since currently it has the rules built with a 100\% confidence}
...
\todo{I will do my edit pass over this section when you address the questions
  from the GH issues; please do that in the morning.}
