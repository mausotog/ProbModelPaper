...
very difficult to solve, specially when taking into account that every bug is different and every program is different.
...
According to Qi et al: ``The prominent generate-and-validate approach starts with 
a test suite of inputs, at least one of which exposes a defect in the software.
...
where the researchers built a probabilistic model of the replace mutation operator based in 
...
of 8 different projects. A similar case is studied by Zhong and Su~\cite{zhong15} with an even smaller number of projects (6) and a smaller set of mutation operators (3). To the best of our knowledge a full set of mutation operators hasn't been studied and compared in the past. Our current study trains with 500 projects, and 
...
Statement-Edition mutation operators to the mutation operators that edit 
statements within the source code but do not create new code as opposed to 
...
art~\cite{long15,Soto15,zhong15}.
