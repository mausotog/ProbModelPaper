...
\newline
\center
  \caption{Description of projects that conform Defects4j}
  \label{defects4j}
\end{table} 
...
in fault localization. Anecdotally, we observe that less-accurate fault localization increases the amount of
