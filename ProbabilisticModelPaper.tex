...
a rule also contained the consequent. A high threshhold like 100\% produces
...
studies in multi-edit repair:\footnote{We
  will release the full list of mutation operator rules post blind-review.}
...
\midrule
Del; App; NullCheck; ObjInit & Del $\wedge$ App $\rightarrow$ NullCheck \\ 
Del, App, NullCheck, Rep  & 2.App \& ParamRep =$>$ Rep \\  
App, NullCheck, CastMut & 3.App \& NullCheck =$>$ ObjInit\\
\bottomrule
