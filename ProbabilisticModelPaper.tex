...
approaches used for automatic error repair use probabilities to select which mutation operator will be applied to construct candidate patches that are either random or adapted from the results of a particular benchmarks, which leads to patches that are harder to understand and less maintainable. In reality, mutation operators have
