...
Prophet~\cite{long15Proph}, HDRepair~\cite{xuan16}) use heuristics or
...
a higher priority to some candidate patches over others based on heuristics~\cite{long15Proph};
...
a distribution identifying how many times each statement is replaced 
