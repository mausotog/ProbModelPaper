...
maintainability~\cite{Liblit03,Anvik05}. \todo{I'm not sure why you've chosen 
these two references for this claim...I think Liblit 03 targets C...what's your 
reasoning? RESPONSE: Liblit talks about how large software systems are deployed 
with bugs and the resources for improving software is always limited.  RESPONSE: 
sure, but they don't say anythning about object oriented languages, scalability, 
or maintainability in particular.  Rephrase the sentence to be broader.}
%
