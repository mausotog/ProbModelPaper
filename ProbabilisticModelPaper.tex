...
(e.g.,~\cite{examples}) typically still only produce small changes in
...
code is \emph{probably} more common than adding a whole new class)~\cite{references}. In this
...
We evaluate the predictive power of our mined models on tgeur own, in terms of their
