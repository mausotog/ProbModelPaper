...
\emph{IfStatement} as seen in Figure~\ref{closure18prob}. PAR in particular has
a mutation operator specially created to perform this task, and even so, it was
not able to find this patch due to the vast search space and the fact that it
searches through this space in an equally distributed manner to pick its
mutation operators. Nopol was able to create a patch for this example as shown
in Figure~\ref{closure18nopol}, but this patch is not able to generalize to a
held-out test suite.
