...
suites. 
Table \ref{stateOfTheArtComparison} shows the status of the different patches found by each of the different approaches and next to each patch a description regarding if the patch passed the held out test suite or failed it. The data regarding the held out test suites used in this study is described in Table \ref{heldOut}. 

\begin{table}[]
\centering
\begin{tabular}{llll}
Project & Number of test cases & Class line coverage & Class branch coverage \\
\hline
