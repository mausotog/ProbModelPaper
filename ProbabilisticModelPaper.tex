...
with $E_{n,m}$\todo{Should this be a vector maybe?} 
...
in this graph, the red bars\todo{Update the text to reflect the way the data is
  actually presented; we don't have bars any more.} represent the results of the percentage of correctly 
