...
As mentioned, we have two high-level research concerns related to the utility of our
...
identify which sets of syntactic mutation operators appear more useful in
...
\paragraph{Comparison to previous techniques} Second, we compare our tool, using the best set of
...
\subsection{Mutation operator and model utility} \label{oputil}
...
\subsubsection{Results} 
 ...
 In the first row of Figure~\ref{tab:singleLineBugs} (Closure \#10) we can see
...
\todo{Summary about conclusions from this study. segue into next subsection}
