...
\center
  \caption{Number of variants it takes to find a patch using different sets of
    ...
    Using Replace. Right) Using Append, Remove and Replace. \todo{Please stop
      using colors and instead use text to label units and provide meaning.  What is the
...
We assess success rate and variants to a repair (as in
...
Table~\ref{tab:singleLineBugs}.\todo{Why is success rate 0 for Chart 1, given
  that repairs were obviously found?} In the first row of Table~\ref{tab:singleLineBugs} (Closure \#10) we can see
